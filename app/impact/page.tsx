      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-primary/5 to-secondary/5">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-foreground/80">
            Our annual impact report provides comprehensive data on the lives
            we've touched, communities we've served, and the real change we're
            creating across Nigeria.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-muted/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-foreground/80 text-center mb-12 max-w-2xl mx-auto">
            Every donation directly supports our programs and brings us closer
            to our mission of equitable healthcare access.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              {
                title: "₦5,000",
                text: "Provides basic health screening for 20 people",
              },
              {
                title: "₦25,000",
                text: "Trains and supports one community health worker for a month",
              },
              {
                title: "₦100,000",
                text: "Establishes a mobile clinic serving 500+ members",
              },
              {
                title: "₦500,000+",
                text: "Implements a community health program for 5,000+ people",
              },
            ].map((don, i) => (
          ...
          <div className="bg-primary/5 rounded-lg p-8 text-center">
            <p className="text-foreground/80 mb-4">
              <strong>100% of donations go directly to programs.</strong> We
              maintain minimal operational costs through partnerships and
              volunteer support.
            </p>
            ...
            {[
              {
                ...
                description:
                  "Providing prenatal care, safe delivery, and postpartum support across 8 communities",
                status: "Active",
              ...
              },
              {
                ...
                description:
                  "Training and equipping local health workers for essential services",
                status: "Active",
              ...
              },
              {
                ...
                description:
                  "Addressing malnutrition through nutrition support and education",
                status: "Active",
              ...
              },
              {
                ...
                description:
                  "Vaccination and education drives in underserved rural areas",
                status: "Active",
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg mb-8 opacity-90">
            Your support creates real change in real communities. Join us in
